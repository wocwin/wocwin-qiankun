				...
				fieldList: [
					{
						...
						type: 'select-arr',
						comp: 't-select',
						bind: { optionSource: this.sexList, valueKey: 'value' }
					},
					{
						label: '状态',
						value: 'status',
						...
						type: 'select-arr',
						comp: 't-select',
						bind: { optionSource: this.statusList, valueKey: 'value' }
					},
					{
						label: '爱好',
						value: 'hobby',
						...
						comp: 't-select',
						list: 'hobbyList',
						bind: { multiple: true, valueKey: 'value', optionSource: this.hobbyList }
					},
					{
						label: '年份',
						value: 'createDate',
