...
// echarts-概况-右-访客汇总
export function getVisitorSummary(params) {
	return request({
 ...
 */
// echarts-订单数据-下单时间分布
export function getOrderTimeData(params) {
	return request({
...
// echarts-订单数据-支付结果
export function getPayResultData(params) {
	return request({
...
// echarts-订单数据-销售趋势
export function getSaleTrendData(params) {
	return request({
...
// echarts-订单数据-订单金额分布
export function getAmountDistributionData(params) {
	return request({
...
export function getLocationDistributionData(params) {
	return request({
...
// echarts-订单数据-订单详情
export function pageOrderData(params) {
	return request({
...
export function getCustOrderData(params) {
	return request({
...
// echarts-用户数据-新增用户
export function getNewCustomerData(params) {
	return request({
...
// echarts-用户数据-访问时段
export function getVisitsTrendData(params) {
	return request({
...
// echarts-商品数据-商品销量排行
export function getSaleRankingData(params) {
	return request({
...
// echarts-商品数据-商品详情
export function pageGoodsData(params) {
	return request({
...
// echarts-页面数据-支付转化
export function getPaymentConversion(params) {
	return request({
...
// echarts-页面数据-页面详情
export function listPageDetails(params) {
	return request({
